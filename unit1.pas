  ...
  begin
    ...
    begin
      ...
      begin
        ...
        self.DataSourceChilds.DataSet.Fields[3].AsInteger := trunc(MyWorksheet.ReadAsNumber(row, 3)); // age
      ...
      begin
        ...
        self.DataSourceGroups.DataSet.Fields[2].AsInteger := trunc(MyWorksheet.ReadAsNumber(row, 2)); // max_count
      end;
    end;
  end;
